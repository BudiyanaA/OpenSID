@php
    $pink = theme_config('pink', '#e83e8c');
    $gradient_left = theme_config('gradient_left', '#8226f5');
    $gradient_right = theme_config('gradient_right', '#e625ea');
    $textlink = theme_config('textlink', '#7979ff');
    $progresbar = theme_config('progresbar', '#f63b55');
    $sidebar = theme_config('sidebar', '#5d2cb4');
    $sidebarhover = theme_config('sidebarhover', '#6831c8');
    $button = theme_config('button', '#0fd793');
    $huruf = theme_config('huruf', '#fff');
@endphp
...
.was-validated .custom-control-input:valid:focus ~ .custom-control-label::before, .custom-control-input.is-valid:focus ~ .custom-control-label::before {
  box-shadow: 0 0 0 1px {{ $huruf }}, 0 0 0 0.2rem rgba(15, 215, 147, 0.25);
}
...
.was-validated .custom-control-input:invalid:focus ~ .custom-control-label::before, .custom-control-input.is-invalid:focus ~ .custom-control-label::before {
  box-shadow: 0 0 0 1px {{ $huruf }}, 0 0 0 0.2rem rgba(246, 59, 85, 0.25);
}
...
.custom-control-input:focus ~ .custom-control-label::before {
  box-shadow: 0 0 0 1px {{ $huruf }}, 0 0 0 0.2rem rgba(121, 121, 255, 0.25);
}
...
.custom-select {
  ...
  color: #495057;
  vertical-align: middle;
  background: {{ $huruf }} url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3E%3Cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3E%3C/svg%3E") no-repeat right 0.75rem center;
...
.nav-tabs .nav-item.show .nav-link {
  color: #495057;
  background-color: {{ $huruf }};
  border-color: #dee2e6 #dee2e6 {{ $huruf }};
}
...
.bg-danger {
  background-color: {{ $progresbar }} !important;
}
...
.bg-white {
  background-color: {{ $huruf }} !important;
}
...
.border-primary {
  border-color: {{ $textlink }} !important;
}
...
.border-danger {
  border-color: {{ $progresbar }} !important;
}
...
.pink-gradient-active:active {
  color: #ffffff !important;
  background-image: -moz-linear-gradient(45deg, {{ $gradient_left }} 0%, {{ $gradient_right }} 100%) !important;
  background-image: -webkit-linear-gradient(45deg, {{ $gradient_left }} 0%, {{ $gradient_right }} 100%) !important;
  background-image: -ms-linear-gradient(45deg, {{ $gradient_left }} 0%, {{ $gradient_right }} 100%) !important;
  border-color: transparent;
  background-color: {{ $gradient_left }} !important;
...
.primary-gradient-active:active {
  color: #ffffff !important;
  background-image: -moz-linear-gradient(45deg, #4a19c8 0%, {{ $textlink }} 100%) !important;
  background-image: -webkit-linear-gradient(45deg, #4a19c8 0%, {{ $textlink }} 100%) !important;
  background-image: -ms-linear-gradient(45deg, #4a19c8 0%, {{ $textlink }} 100%) !important;
  border-color: transparent;
...
.success-gradient-active:active {
  color: #ffffff !important;
  background-image: -moz-linear-gradient(45deg, #07ba7d 0%, {{ $button }} 100%) !important;
  background-image: -webkit-linear-gradient(45deg, #07ba7d 0%, {{ $button }} 100%) !important;
  background-image: -ms-linear-gradient(45deg, #07ba7d 0%, {{ $button }} 100%) !important;
  border-color: transparent;
...
.danger-gradient-active:active {
  color: #ffffff !important;
  background-image: -moz-linear-gradient(45deg, #cf0723 0%, {{ $progresbar }} 100%) !important;
  background-image: -webkit-linear-gradient(45deg, #cf0723 0%, {{ $progresbar }} 100%) !important;
  background-image: -ms-linear-gradient(45deg, #cf0723 0%, {{ $progresbar }} 100%) !important;
  border-color: transparent;
...
.tabs-footer .nav-tabs .nav-item .nav-link.active {
  border-top: 3px solid {{ $gradient_right }};
  opacity: 1;
}
...
.nav-tabs .nav-link.active {
  background-color: transparent;
  border-bottom: 3px solid {{ $gradient_right }};
  opacity: 1;
}
...
.storyline .story-block.left.border-danger .card {
  border-right: 4px solid {{ $progresbar }} !important;
}

.storyline .story-block.left.border-danger:before {
  border-left: 10px solid {{ $progresbar }};
}

.storyline .story-block.left.border-success .card {
  border-right: 4px solid {{ $button }} !important;
}

.storyline .story-block.left.border-success:before {
  border-left: 10px solid {{ $button }};
}
...
.storyline .story-block.left.border-primary .card {
  border-right: 4px solid {{ $textlink }} !important;
}

.storyline .story-block.left.border-primary:before {
  border-left: 10px solid {{ $textlink }};
}
...
.storyline .story-block.right.border-danger .card {
  border-left: 4px solid {{ $progresbar }} !important;
}

.storyline .story-block.right.border-danger:before {
  border-right: 10px solid {{ $progresbar }};
}

.storyline .story-block.right.border-success .card {
  border-left: 4px solid {{ $button }} !important;
}

.storyline .story-block.right.border-success:before {
  border-right: 10px solid {{ $button }};
}
...
.storyline .story-block.right.border-primary .card {
  border-left: 4px solid {{ $textlink }} !important;
}

.storyline .story-block.right.border-primary:before {
  border-right: 10px solid {{ $textlink }};
}
