                ...
                <div class="card mb-3">
                    <div class="card-header p-0">
                        <ul class="nav nav-tabs wizard-1" role="tablist">
                            ...
                            @if (count($yad ?? []) > 0)
                                <li class="nav-item">
                                    <a class="nav-link {{ count($hari_ini ?? []) == 0 ? 'active' : '' }}" id="tabyad-tab" data-toggle="tab" href="#tabyad" role="tab" aria-controls="tabyad" aria-selected="false">
                                        <span>Mendatang</span>
                                    </a>
                                </li>
                            @endif
                            @if (count($lama ?? []) > 0)
                                <li class="nav-item">
                                    <a class="nav-link {{ count(array_merge($hari_ini ?? [], $yad ?? [])) == 0 ? 'active' : '' }}" id="tablama-tab" data-toggle="tab" href="#tablama" role="tab" aria-controls="tablama" aria-selected="false">
                                        <span>Terdahulu</span>
                                    </a>
                                </li>
                            @endif
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            @if (count(array_merge($hari_ini ?? [], $yad ?? [], $lama ?? [])) > 0)
                                ...
                                <div class="tab-pane fade {{ count($hari_ini ?? []) == 0 ? 'show active' : '' }}" id="tabyad" role="tabpanel" aria-labelledby="tabyad-tab">
                                    @if (count($yad ?? []) > 0)
                                ...
                                <div class="tab-pane fade {{ count(array_merge($hari_ini ?? [], $yad ?? [])) == 0 ? 'show active' : '' }}" id="tablama" role="tabpanel" aria-labelledby="tablama-tab">
